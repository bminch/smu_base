...
uint16_t cmd_buffer_left, end_fwd_char_count;
...
void adc16_ch1avg16Q_handler(char *args);
void adc16_ch2avg16Q_handler(char *args);
...
DISPATCH_ENTRY_T adc16_table[] = {{ "CH1?", adc16_ch1Q_handler }, 
                                  ...
                                  { "CH1AVG16?", adc16_ch1avg16Q_handler }, 
                                  { "CH2AVG16?", adc16_ch2avg16Q_handler }, 
...
void adc24_ch1avg9Q_handler(char *args);
void adc24_ch2avg9Q_handler(char *args);
...
void adc24_bothavg9Q_handler(char *args);
...
DISPATCH_ENTRY_T adc24_table[] = {{ "CH1?", adc24_ch1Q_handler }, 
                                  ...
                                  { "CH1AVG9?", adc24_ch1avg9Q_handler }, 
                                  { "CH2AVG9?", adc24_ch2avg9Q_handler }, 
                                  ...
                                  { "BOTHAVG9?", adc24_bothavg9Q_handler }, 
...
void adc16_ch1avg16Q_handler(char *args) {
    ...
    hex2str_alt((uint16_t)adc16_meas_ch1_avg16(), str);
    cdc_puts(str);
    cdc_puts("\r\n");
}
...
void adc16_ch2avg16Q_handler(char *args) {
    ...
    hex2str_alt((uint16_t)adc16_meas_ch2_avg16(), str);
    cdc_puts(str);
    cdc_puts("\r\n");
}
...
void adc24_ch1avg9Q_handler(char *args) {
    ...
    adc24_meas_both_avg9(&val1, &val2);
    hex2str_alt((uint16_t)(val1 & 0xFFFF), str);
    cdc_puts(str);
    cdc_putc(',');
    hex2str_alt((uint16_t)((uint32_t)val1 >> 16), str);
